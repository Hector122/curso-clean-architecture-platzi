...
class ClippedView @JvmOverloads constructor(context: Context,
    ...
    // Store locally what have been draw
    ...
    private fun drawClippedRectangle(canvas: Canvas) {
        ...
        //Add code to fill the canvas with white color.
        ...
        paint.color = Color.BLUE // Align the RIGHT side of the text with the origin.
    ...
    private fun drawDifferenceClippingExample(canvas: Canvas) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) canvas.clipRect(4 * rectInset,
                4 * rectInset,
                clipRectRight - 4 * rectInset,
                clipRectBottom - 4 * rectInset,
                Region.Op.DIFFERENCE)
        else {
            canvas.clipOutRect(4 * rectInset,
                    4 * rectInset,
                    clipRectRight - 4 * rectInset,
                    clipRectBottom - 4 * rectInset)
        }
